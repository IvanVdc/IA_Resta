...
PABLO: Eliminado por este error:
lib/objects/segment-image.o: In function `smooth(image<unsigned char>*, float)':
/home/pablo/EEPP/hybrid3/lib/segment/filter.h:57: multiple definition of `smooth(image<unsigned char>*, float)'
mixed.o:mixed.cpp:(.text+0x3f68): first defined here
