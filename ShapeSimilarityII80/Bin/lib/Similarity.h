...
//distancias maximas
#define MAX_DIST_KEC		2
#define MAX_DIST_A_OR_TC	4
#define MAX_DIST_L		6
#define MAX_DIST_C		1
#define MAX_DIST_A_OR_TC_INTERVALAR 140
#define MAX_DIST_L_INTERVALAR 6.95
...
class Similarity {
  public:
    ...
    float dissimilarity_between_points_intervalar(QPoint qpt1, QPoint qpt2, float *dist_points, float *dist_angle_curvature, float *dist_length, float *dist_convexity);
    ...
    int kind_edges_connected[6][6];

    //Angle
    int angle3[4][4];

    //Curves
    int curvature_angle5[6][6];
    ...
    float curvature_angle_intervalar[6][6];

    float length_intervalar[8][8];
