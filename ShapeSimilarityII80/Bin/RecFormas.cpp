...
int main(int argc, char ** argv)
{
	...
	clock_t startFE, finishFE, startQD, finishQD, startDesc, finishDesc, startMatch, finishMatch,
			startDescMap, finishDescMap, startSimQSD, finishSimQSD;
	double FElenght, QDlenght, SimQSDlenght, totalLenght, descLenght, matchLenght, descMapLenght;
	...
	if (!matching)
	{
		...
		for (int k = init; k < argc; k++)
		{
			...
			try
			{
				...
				//cout << "FE execution time: " << FElenght / CLOCKS_PER_SEC << endl;
				//cout << "QD execution time: " << QDlenght / CLOCKS_PER_SEC << endl;
				//cout << "Total execution time: " << totalLenght / CLOCKS_PER_SEC << endl;
		...
		else if (distest == 2)
		{
			...
			finishSimQSD = clock();
			SimQSDlenght = (double) (finishSimQSD - startSimQSD);
			/*********************************/

			totalLenght = FElenght + QDlenght + SimQSDlenght;
			cout << "FE execution time: " << FElenght / CLOCKS_PER_SEC << endl;
			cout << "QD execution time: " << QDlenght / CLOCKS_PER_SEC << endl;
			cout << "SimQSD execution time: " << SimQSDlenght / CLOCKS_PER_SEC << endl;
			cout << "Total execution time: " << totalLenght / CLOCKS_PER_SEC << endl;
